...
import type {AgentSettingsFrontend, KnowledgeDocument as KnowledgeDocumentAPI} from "@/services/crmAgentsService";
            ...
            Promise.all([
                ...
                .then(([apiSettings, apiDocuments, apiIntegrations]) => {
                    ...
                    if (apiSettings.schedule.enabled) {
                        ...
                        if (apiSettings.schedule.workingHours && apiSettings.schedule.workingHours.length > 0) {
                            // Start with defaults

                            // Override with API data
                            (apiSettings.schedule.workingHours as ApiWorkingHour[]).forEach((apiHour) => {
                    ...
                    setSettings({
                        ...
                        knowledgeBase: (apiDocuments as KnowledgeDocumentAPI[]).map((doc) => ({
                            id: doc.id,
                            name: doc.name,
    ...
    const handleFileUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            const uploadPromises = Array.from(files).map(async (file) => {
                ...
                // Upload to API
                const uploadedDoc = await crmAgentsService.uploadKnowledgeDocument(agent.id, file) as KnowledgeDocumentAPI;
            ...
            const successfulUploads = results.filter((doc) => doc !== null) as KnowledgeDocument[];
            ...
            setSettings((prev) => ({
                ...
                advanced: {
                    ...
                    handoffTriggers: {
                        ...
                        keywords: [...prev.advanced.handoffTriggers.keywords, newKeyword.trim()],
                    },
                },
            }));
            setNewKeyword("");
    ...
    const handleRemoveKeyword = (index: number) => {
        setSettings((prev) => ({
            ...
            advanced: {
                ...
                handoffTriggers: {
                    ...prev.advanced.handoffTriggers,
                    keywords: prev.advanced.handoffTriggers.keywords.filter((_, i) => i !== index),
                },
            },
        }));
    };
                ...
                {loading && (
                    <div className="flex-1 flex items-center justify-center">
                        <div className="text-center space-y-3">
                            ...
                            <p className="text-sm text-muted-foreground">Memuat pengaturan agent...</p>
                        </div>
                    </div>
                )}
                    ...
                    <>
                        ...
                        <Tabs defaultValue="persona" className="flex-1 flex flex-col overflow-hidden">
                                ...
                                <TabsContent value="persona" className="mt-0 space-y-4">
                                    <Card>
                                        ...
                                        <CardContent className="space-y-4">
                                            ...
                                            {/* Custom Instructions */}
                                            <div className="space-y-2">
                                                <Label htmlFor="instructions">Custom Instructions / Prompt</Label>
                                                <Textarea
                                                    id="instructions"
                                                ...
                                                <p className="text-xs text-muted-foreground">
                                                    Instruksi ini akan menjadi panduan utama agent dalam berinteraksi
                                                    dengan
                                                    customer.
                                                </p>
                                            </div>
                                ...
                                <TabsContent value="knowledge" className="mt-0 space-y-4">
                                    <Card>
                                        <CardHeader>
                                            ...
                                            <CardDescription>
                                                Upload dokumen yang akan menjadi sumber pengetahuan agent
                                            </CardDescription>
                                        </CardHeader>
                                        <CardContent className="space-y-4">
                                            {/* Upload Area */}
                                            ...
                                            {settings.knowledgeBase.length > 0 && (
                                                <div className="space-y-2">
                                                    <Label>Uploaded Documents ({settings.knowledgeBase.length})</Label>
                                                    <div className="space-y-2">
                                                ...
                                                <Switch
                                                    ...
                                                    onCheckedChange={(checked) =>
                                                        setSettings((prev) => {
                                                            ...
                                                            const dayNamesLocal = ['Senin', 'Selasa', 'Rabu', 'Kamis', 'Jumat', 'Sabtu', 'Minggu'];
                                                            const defaultWorkingHoursLocal = dayNamesLocal.map((day, index) => ({
                                                                day,
                                                                enabled: index < 5,
                                                                start: '09:00',
                                                                end: '17:00',
                                                            ...
                                                            return {
                                                                ...
                                                                schedule: {
                                                                    ...
                                                                    enabled: true,
                                                                    workingHours:
                                                                        prev.schedule.workingHours && prev.schedule.workingHours.length > 0
                                        ...
                                        <CardContent className="space-y-4">
                                            ...
                                            {settings.schedule.enabled ? (
                                                ...
                                                <div className="text-sm text-muted-foreground">
                                                    Scheduling tidak aktif — aktifkan "Working Hours" untuk mengatur jam
                                                    per-hari.
                                                </div>
                                            )}
                                            ...
                                            {settings.schedule.enabled && (
                                                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                                                    <p className="text-xs text-blue-800">
                                                        <strong>Note:</strong> Agent hanya akan merespons chat di luar
                                                        jam kerja
                                                        dengan auto-reply message.
                                                    </p>
                                                </div>
                                            )}
                                        </CardContent>
                                                    ...
                                                    <div
                                                        ...
                                                        onClick={() =>
                                                            setSettings((prev) => ({
                                                                ...
                                                                advanced: {
                                                                    ...prev.advanced,
                                                                    temperature: option.value as "consistent" | "balanced" | "creative",
                                                                },
                                                            }))
                                                        }
                                                    >
                                        ...
                                        <CardContent className="space-y-4">
                                            <div className="space-y-2">
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <Badge>{settings.advanced.historyLimit} messages</Badge>
                                                </div>
                                                <Input
                                                    id="historyLimit"
                                                    type="range"
                                            ...
                                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                                                <p className="text-xs text-blue-800">
                                                    <strong>Note:</strong> History yang lebih panjang = context yang
                                                    lebih baik,
                                                    tapi biaya API lebih tinggi.
                                                </p>
                                            </div>
                                        </CardContent>
                                    </Card>
                                        ...
                                        <CardHeader>
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    ...
                                                    <CardDescription>
                                                        Kondisi yang memicu AI untuk transfer chat ke agent manusia
                                                    </CardDescription>
                                                </div>
                                                <Switch
                                            ...
                                            <CardContent className="space-y-4">
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="flex flex-wrap gap-2 mt-2">
                                                        {settings.advanced.handoffTriggers.keywords.map((keyword, index) => (
                                                    ...
                                                    <p className="text-xs text-muted-foreground">
                                                        Jika customer mengetik keyword ini, AI akan otomatis transfer ke
                                                        agent.
                                                    </p>
                                                </div>
                                                ...
                                                <div className="space-y-2">
                                                    <div className="flex items-center justify-between">
                                                        ...
                                                        <Badge variant="outline">
                                                            {settings.advanced.handoffTriggers.sentimentThreshold}
                                                        </Badge>
                                                    </div>
                                                    <Input
                                                        type="range"
                                                        ...
                                                        max="0"
                                                        step="0.1"
                                                        value={settings.advanced.handoffTriggers.sentimentThreshold}
                                                        onChange={(e) =>
                                                            setSettings((prev) => ({
                                                                ...prev,
                                                                advanced: {
                                                    ...
                                                    <p className="text-xs text-muted-foreground">
                                                        Transfer jika sentiment customer di bawah threshold ini.
                                                    </p>
                                                </div>
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        <Input
                                                            ...
                                                            min="1"
                                                            max="10"
                                                            value={settings.advanced.handoffTriggers.unansweredQuestions}
                                                            onChange={(e) =>
                                                                setSettings((prev) => ({
                                                                    ...prev,
                                                                    advanced: {
                                                                        ...
                                                                        handoffTriggers: {
                                                                            ...prev.advanced.handoffTriggers,
                                                                            unansweredQuestions: parseInt(e.target.value) || 1,
                                                                        },
                                                                    },
                                                                }))
                                                            }
                          ...
                          questions
                                                    ...
                                                    <p className="text-xs text-muted-foreground">
                                                        Transfer jika AI gagal menjawab pertanyaan customer sebanyak
                                                        ini.
                                                    </p>
                                                </div>
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <Textarea
                                                        ...
                                                        rows={3}
                                                        value={settings.advanced.handoffTriggers.escalationMessage}
                                                        onChange={(e) =>
                                                            setSettings((prev) => ({
                                                                ...prev,
                                                                advanced: {
                                                    ...
                                                    />
                                                    <p className="text-xs text-muted-foreground">
                                                        Pesan ini akan dikirim ke customer sebelum transfer ke agent
                                                        manusia.
                                                    </p>
                                                </div>
                                                ...
                                                <div className="bg-orange-50 border border-orange-200 rounded-lg p-3">
                                                    <p className="text-xs text-orange-800">
                                                        <strong>Warning:</strong> Pastikan ada agent manusia yang
                                                        available untuk
                                                        handle transfer. Jika tidak ada, chat akan tetap di queue.
                                                    </p>
                                                </div>
                                            </CardContent>
                                        )}
                                        ...
                                        <CardHeader>
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    ...
                                                    <CardDescription>
                                                        Kelola sistem ticketing untuk tracking issue customer
                                                    </CardDescription>
                                                </div>
                                                <Switch
                                                    ...
                                                    onCheckedChange={(checked) =>
                                                        setSettings((prev) => ({
                                                            ...prev,
                                                            ticketing: {...prev.ticketing, enabled: checked},
                                                        }))
                                                    }
                                                />
                                            </div>
                                        ...
                                        {settings.ticketing.enabled && (
                                            <CardContent className="space-y-4">
                                                ...
                                                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                                    <h4 className="font-semibold text-blue-900 mb-2">Tentang Ticketing
                                                        System</h4>
                                                    <p className="text-sm text-blue-800">
                                                        Sistem ticketing memungkinkan 1 chat/percakapan memiliki
                                                        multiple tickets untuk
                                                        berbagai issue yang berbeda. Setiap ticket dapat di-track secara
                                                        terpisah dengan
                                                        status, kategori, dan prioritasnya masing-masing.
                                                    </p>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <div className="space-y-1">
                                                        <Label htmlFor="autoCreateTicket"
                                                               className="text-base font-medium">
                                                            Auto Create Ticket
                                                        </Label>
                                                        <p className="text-sm text-muted-foreground">
                                                            Otomatis buat ticket baru ketika percakapan dimulai
                                                        </p>
                                                    </div>
                                                    <Switch
                                                        id="autoCreateTicket"
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    />
                                                    <p className="text-xs text-muted-foreground">
                                                        Contoh: Dengan prefix "TKT-", ticket ID akan menjadi TKT-001,
                                                        TKT-002, dst.
                                                    </p>
                                                </div>
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="flex flex-wrap gap-2 mt-2">
                                                        {settings.ticketing.categories.map((category, index) => (
                                                            <Badge key={index} variant="secondary" className="gap-1">
                                                                {category}
                                                                <button
                                                                    type="button"
                                                    ...
                                                    <p className="text-xs text-muted-foreground">
                                                        Kategori ini akan digunakan untuk mengklasifikasikan ticket.
                                                    </p>
                                                </div>
                                                ...
                                                <Card className="border-2">
                                                    <CardHeader>
                                                        <div className="flex items-center justify-between">
                                                            <CardTitle className="text-base">Auto-Close Resolved
                                                                Tickets</CardTitle>
                                                            <Switch
                                                                checked={settings.ticketing.autoCloseAfterResolved}
                                                                onCheckedChange={(checked) =>
                                                                    setSettings((prev) => ({
                                                                        ...prev,
                                                                        ticketing: {
                                                        ...
                                                        <CardDescription>
                                                            Otomatis close ticket setelah status resolved dalam waktu
                                                            tertentu
                                                        </CardDescription>
                                                    </CardHeader>
                                                    {settings.ticketing.autoCloseAfterResolved && (
                                                        <CardContent>
                                                            <div className="space-y-2">
                                                                <Label htmlFor="autoCloseDelay">Auto-Close Delay
                                                                    (Hours)</Label>
                                                                <div className="flex items-center gap-3">
                                                                    <Input
                                                                        id="autoCloseDelay"
                                                                        ...
                                                                        onChange={(e) =>
                                                                            setSettings((prev) => ({
                                                                                ...
                                                                                ticketing: {
                                                                                    ...prev.ticketing,
                                                                                    autoCloseDelay: parseInt(e.target.value) || 24,
                                                                                },
                                                                            }))
                                                                        }
                                                                        className="w-24"
                                                                    />
                                                                    <span
                                                                        className="text-sm text-muted-foreground">jam</span>
                                                                </div>
                                                                <p className="text-xs text-muted-foreground">
                                                                    Ticket akan otomatis closed
                                                                    setelah {settings.ticketing.autoCloseDelay} jam
                                                                    dari status resolved (max 168 jam/7 hari)
                                                                </p>
                                                            </div>
                                                        </CardContent>
                                                    )}
                                                ...
                                                <Card className="bg-muted">
                                                    <CardHeader>
                                                        <CardTitle className="text-base">Ticket Status
                                                            Lifecycle</CardTitle>
                                                    </CardHeader>
                                                    <CardContent>
                                                        <div className="space-y-2">
                                                            ...
                                                            <p className="text-xs text-muted-foreground mt-3">
                                                                <strong>Open:</strong> Ticket baru dibuat<br/>
                                                                <strong>In Progress:</strong> Agent sedang menangani
                                                                ticket<br/>
                                                                <strong>Resolved:</strong> Issue sudah diselesaikan,
                                                                menunggu konfirmasi<br/>
                                                                <strong>Closed:</strong> Ticket selesai dan arsip
                                                            </p>
                                                        </div>
                                                    </CardContent>
                                                </Card>
